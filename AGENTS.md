# Marko Inertia Svelte Skeleton - Agent Guide

This is a standalone `composer create-project` skeleton for Marko applications using Inertia.js and Svelte.
...
- PHP 8.5+
- Composer project package: `marko/skeleton-inertia-svelte`
...
The app intentionally contains only one Inertia adapter. Do not add Vue or React dependencies, routes, components, or Vite inputs to this skeleton.
