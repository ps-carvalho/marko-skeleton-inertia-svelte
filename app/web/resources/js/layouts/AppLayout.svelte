...
<div class="min-h-screen bg-gray-50">
  <aside
    class="fixed inset-y-0 left-0 z-50 w-64 border-r border-gray-200 bg-white"
  >
    ...
    >
      <div class="flex items-center gap-3">
        <div
          class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-indigo-100"
        >
